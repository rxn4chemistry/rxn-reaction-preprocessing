...
@click.option(
    ...
    "-f",
    required=True,
    default=["pistachio.cansmi.reduced", "pistachio.smi.reduced"],
...
@click.option(
    ...
    required=True,
    default=False,
    help="Boolean to set the presence of atom mapped reactions",
)
def main(
    datapath: str, destpath: str, filenames: List[str], atom_mapping: bool
) -> None:
