...
class RejectedMoleculesFilter:
    ...
    def is_valid_reaction_smiles(self, smiles: str, fragment_bond: Optional[str] = None) -> bool:
        """
        ...
        """
        return self.is_valid_reaction_equation(ReactionEquation.from_string(smiles, fragment_bond))
    ...
    def is_valid_reaction_equation(self, reaction_equation: ReactionEquation) -> bool:
        ...
        """
        return all(
            self.is_valid_molecule_smiles(smiles) for smiles in reaction_equation.iter_all_smiles()
        )
    ...
    def from_molecule_annotations(
        ...
        """
        rejected_molecules = (
            annotation.original_without_fragment_bond for annotation in molecule_annotations
