...
def main(csv_file: str, column_name):
    """Check for missing catalyst annotations."""
    ...
    molecules_requiring_annotation = list(
        missing_annotation_detector.missing_in_reaction_smiles(iterator, fragment_bond='~')
    )
    ...
    annotated = [m for m in molecules_requiring_annotation if annotation_info.is_annotated(m)]
