...
def test_molecule_filter_with_reaction_smiles():
    ...
    assert not molecule_filter.is_valid_reaction_smiles('C.C[O-]~[Na+]>>CCO', fragment_bond='~')
    assert not molecule_filter.is_valid_reaction_smiles('C.C[O-]%[Na+]>>CCO', fragment_bond='%')
    assert molecule_filter.is_valid_reaction_smiles('C.C[O-].[Na+]>>CCO', fragment_bond='~')
